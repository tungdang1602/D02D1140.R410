...
Imports System.Text
''' <summary>
''' D02E1140: Chứa các màn hình Danh mục
...
#End If
    ...
    Private Sub GetAllParameter()
        ...
        '    PARA_SaveRecentValues = CType(D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "SaveRecentValues", "False"), Boolean)
        '-----------------------------------------------------------------------
    ...
    Private Sub SaveParameter()
        Dim sFormID As String = "D02F2000"
        'sFormID = "D02F1030"
        'sFormID = "D02F2000"

        Dim sDivisionID As String = "TUONGAN"
        Dim sTranMonth As String = "09"
        Dim sTranYear As String = "2013"
